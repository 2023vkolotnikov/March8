...
wrongAnswer4.addEventListener("click", () => {
  console.log("bad");
  score--;
  console.log(score);
});
...
wrongAnswer8.addEventListener("click", () => {
  console.log("bad");
  score--;
  console.log(score);
});
...
wrongAnswer21.addEventListener("click", () => {
  console.log("bad");
  score--;
  console.log(score);
});
...
wrongAnswer25.addEventListener("click", () => {
  console.log("bad");
  score--;
  console.log(score);
});
wrongAnswer26.addEventListener("click", () => {
  console.log("bad");
  score--;
  console.log(score);
});
